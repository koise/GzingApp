<?php
/**
 * Create Log Test Endpoint (No Authentication Required)
 * POST /logs/create_log_test.php
 * 
 * Creates either navigation logs or user activity logs based on log_type
 * This is a test endpoint that accepts user_id as parameter
 */
...
try {
    ...
    $requiredFields = ['log_type', 'user_id'];
    ...
    // Get user data
    $userStmt = $conn->prepare("SELECT id, first_name, last_name, email FROM users WHERE id = ?");
