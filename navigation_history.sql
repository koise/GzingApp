...
-- Foreign key constraints commented out for compatibility
-- CONSTRAINT `fk_navigation_history_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
-- CONSTRAINT `fk_navigation_history_log` FOREIGN KEY (`navigation_log_id`) REFERENCES `user_navigation_logs` (`id`) ON DELETE SET NULL
